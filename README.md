...
- [빅데이터이해 온라인강좌 수강 정리](99_TIL/2026/05/2026-05-06-빅데이터이해-온라인강좌.md) — DT·빅데이터 3V·머신러닝·Hadoop/Spark 개요
...
| 과정 | 기관 | 시기 |
|------|------|------|
| 머신러닝을 활용한 데이터 분석 | 경남 빅데이터 허브 | 2026.05 |
| 데이터 분석 기초 및 데이터 활용 이해 | 경남 빅데이터 허브 | 2026.05 |
| Google Gemini를 활용한 Agent 기반 자동화 | 경남 빅데이터 허브 | 2026.05 |
| 빅데이터이해 온라인강좌 | 경남 빅데이터센터 | 2026.05 |
