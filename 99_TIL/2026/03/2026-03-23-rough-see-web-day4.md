# Day 4 작업 일지 (2026-03-23)

## 작업 개요
CLI 환경 구축 — Supabase CLI + Vercel CLI 설치 및 프로젝트 연결  
VSCode에서 Claude Code를 통해 Supabase DB 및 Vercel 배포를 CLI로 직접 관리할 수 있는 환경 구축.
...
vercel link
# → pandamails-projects/rough-see 연결 완료
